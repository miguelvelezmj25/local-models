...
public class ConvertCallStackDiffTest {
  ...
  @Test
  public void fireProgressChanged_PLATFORM_FALSE() throws IOException, DiffException {
    String programName = BaseConvertAdapter.PROGRAM_NAME;
    CallStackDiff differ =
        new CallStackDiff(
            programName,
  ...
  @Test
  public void verticalFromWorkToDst_PLATFORM_FALSE() throws IOException, DiffException {
    String programName = BaseConvertAdapter.PROGRAM_NAME;
    CallStackDiff differ =
        new CallStackDiff(
            programName,
  ...
  @Test
  public void horizontallyFromSrcToWork_PLATFORM_FALSE() throws IOException, DiffException {
    String programName = BaseConvertAdapter.PROGRAM_NAME;
    CallStackDiff differ =
        new CallStackDiff(
            programName,
  ...
  @Test
  public void compressJpeg_PLATFORM_FALSE() throws IOException, DiffException {
    String programName = BaseConvertAdapter.PROGRAM_NAME;
    CallStackDiff differ =
        new CallStackDiff(
            programName,
  ...
  @Test
  public void scale_PLATFORM_FALSE() throws IOException, DiffException {
    String programName = BaseConvertAdapter.PROGRAM_NAME;
    CallStackDiff differ =
        new CallStackDiff(
            programName,
