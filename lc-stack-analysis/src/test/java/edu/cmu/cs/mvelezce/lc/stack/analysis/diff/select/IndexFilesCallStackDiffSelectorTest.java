...
public class IndexFilesCallStackDiffSelectorTest {
  ...
  @Test
  public void rehash_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void readVInt_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void reorder_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void DataOutput_writeVInt_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void TermsHashPerField_writeVInt_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void writeVLong_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void add_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void writeTerm_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void quicksort_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void readByte_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void init_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void FSDirectory$FSIndexOutput$1_write_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void BlockTreeTermsWriter$TermsWriter_write_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
  ...
  @Test
  public void writeBlock_MAX_TOKEN_LENGTH_FALSE() throws IOException {
    String programName = BaseIndexFilesAdapter.PROGRAM_NAME;
    CallStackDiffSelector selector =
        new CallStackDiffSelector(
            programName,
