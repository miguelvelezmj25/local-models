...
public class IDTAPrettyBuilderTest {
  ...
  public void test2() throws IOException, InterruptedException {
    Partition partition1 =
        new Partition(FeatureExprUtils.parseAsFeatureExpr(IDTA.USE_BDD, "!A && !B"));
    Partition partition2 =
        new Partition(FeatureExprUtils.parseAsFeatureExpr(IDTA.USE_BDD, "!A && B"));
    Partition partition3 =
        new Partition(FeatureExprUtils.parseAsFeatureExpr(IDTA.USE_BDD, "A && !B"));
    ...
    Map<Partition, Double> perfModel = new HashMap<>();
    perfModel.put(partition1, 3000000000.0);
    perfModel.put(partition2, 5000000000.0);
    perfModel.put(partition3, 2000000000.0);
    perfModel.put(partition4, 2000000000.0);
